...
![Khan's academy Logarithms Lesson](screenshot-2026-08-04-145316.png "Khan's academy Logarithms Lesson")
...
* Every binary search step: data gets cut in half.
  The question: how many times do you halve it until only 1 is left?
...
I didn't continue since I have more important things to do (read: [https://khalil-lab.netlify.app/lab-notebook/thalassemia-capture-app-dev-log/)](https://khalil-lab.netlify.app/lab-notebook/thalassemia-capture-app-dev-log/). After finishing that project, I started reading the third chapter
